    ...
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center mb-4 mt-24 gap-8">
      ...
      <div className="flex flex-col gap-4 mx-8 md:mx-0 items-center md:items-start">
        ...
        <div className="flex items-center gap-2 mt-2">
          <Link
            href="/signup"
            className="bg-blue-600 text-white px-6 py-3 rounded-3xl font-medium hover:bg-blue-800"
          >
            Sign up for free
          </Link>
          <Link
            href="/faqs"
            className="border border-blue-600 text-blue-600 px-6 py-3 rounded-3xl hover:text-blue-800 hover:border-blue-800 font-semibold"
          >
            Learn how to hire
          </Link>
        </div>
