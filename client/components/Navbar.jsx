...
export default function Navbar(props) {
  ...
  useEffect(() => {
    const savedValue = sessionStorage.getItem("showBanner");
    savedValue !== null ? setShowBanner(false) : setShowBanner(true);
  }, []);
  ...
  return (
    <nav className={styles.navbar}>
      {isAndroid && showBanner && (
        <div className='bg-neutral-900 px-2 py-1 w-full flex items-center justify-between gap-1'>
          <div className='flex items-center justify-between w-full'>
            <div className='flex items-center gap-2'>
              ...
              />
              <div>
                <h2 className='text-neutral-100 text-sm'>
                  Fipezo - Hire Freelancers
                </h2>
            ...
            <Link
              ...
              className='bg-blue-600 px-1 py-0.5 capitalize text-neutral-100 rounded-md font-semibold'
            >
              install
            </Link>
          </div>
