                ...
                >
                  ...
                  {this.state.currentPage === 2 && (
                    <div className={styles.inputField} id={styles.phone}>
                      <label htmlFor="companyphone" className={styles.label}>
                        <span style={{ color: "white" }}>* </span>Company Phone
                        :
                      </label>
                      <input
                        type="tel"
                  ...
                  {this.state.currentPage === 5 && (
                    <div className={styles.inputField} id={styles.address}>
                      ...
                      <div id="companyaddress" className="flex flex-col gap-4">
                        <input
                          type="text"
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className={styles.inputField}>
                            ...
                            >
                              ...
                              <option className={styles.option} value="Gujarat">
                                Gujarat
                              </option>
                              <option className={styles.option} value="Haryana">
                                Haryana
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Kerala">
                                Kerala
                              </option>
                              <option className={styles.option} value="Ladakh">
                                Ladakh
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Manipur">
                                Manipur
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Mizoram">
                                Mizoram
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Odisha">
                                Odisha
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Punjab">
                                Punjab
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Sikkim">
                                Sikkim
                              </option>
                              <option
                                className={styles.option}
                              ...
                              <option className={styles.option} value="Tripura">
                                Tripura
                              </option>
                              <option
                                className={styles.option}
