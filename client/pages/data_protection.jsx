      ...
      <div className={styles.main}>
        <div className={styles.body}>
          <div
            ...
            style={{ height: "88.3vh" }}
          >
            <Link className="block flex justify-end" href="/">
              <Image
                src="/cross.png"
                height={28}
                width={28}
            ...
            <p className={styles.para}>
              At FIPEZO, we prioritize the security and privacy of our
              users&apos; data. We are committed to maintaining the highest
              standards of data protection to ensure that your personal
              information remains safe and secure. Our commitment to
              safeguarding your data is reflected in the following principles:
              ...
              services and user experience. However, this data will never
              ...
              <span className="block mt-4">
                ...
                working to enhance our data security practices and welcome
                feedback from our users to further improve our measures.
              </span>
              <span className="block mt-4">
