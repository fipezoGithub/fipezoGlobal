...
const CancellationAndRefund = (props) => {
  return (
    <>
      ...
      />
      <div className="mt-16 mx-8 flex flex-col items-center gap-4 mb-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg">
                Services on Fipezo may be eligible for return or exchange under
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg">
                To initiate a cancellation, return, or exchange, please contact
                ...
                purchase date, along with a brief description of the reason for
                cancellation or refund.
                <br />
                <br />
                Our customer support team will guide you through the process and
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg">
                Once a return or refund request is approved, the processing time
                for refunds is typically 3-5 days. Please note that the exact
                time may vary depending on your payment method and financial
                institution.
              </p>
            </div>
            <div className="flex gap-2 flex-col">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="text-lg">
                Fipezo reserves the right to modify or update this Cancellation
                and Refund Policy at any time. Changes will be effective
                immediately upon posting on our website. It is the
