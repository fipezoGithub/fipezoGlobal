...
function Company_Profile(props) {
  ...
  return (
    <div className={style.profile}>
      <Head>
        <title>Fipezo | Your Profile</title>
      </Head>
      ...
      <div className={style.body}>
        <div className={style.profileBox}>
          {!editProfile && <div className={style.form}>
            {!editProfile && <div className={style.coverPicture} style={{ backgroundImage: `url(https://fipezo-bucket.s3.ap-south-1.amazonaws.com/${coverPicture})` }}>
            </div>}
            {!editProfile && <div className={style.profileImage}>
              <div className={style.dp} style={{ backgroundImage: `url(https://fipezo-bucket.s3.ap-south-1.amazonaws.com/${profilePicture})` }}></div>
            </div>}
          ...
          {editProfile && <div className={style.editProfile}>
            <form className={style.form} encType="multipart/form-data" onSubmit={handleEditProfile}>
              <div className={style.editCoverPicture} style={{ backgroundImage: `url(${cover ? cover : (coverPicture ? `https://fipezo-bucket.s3.ap-south-1.amazonaws.com/${user.coverPicture}` : '/dp.png')})` }}>
              ...
              <div className={style.editProfileImage} style={{
                backgroundImage: `url(${image ? image : (profilePicture ? `https://fipezo-bucket.s3.ap-south-1.amazonaws.com/${user.profilePicture}` : '/dp.png')})`,
              }}>
