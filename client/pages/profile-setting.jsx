    ...
    <>
      ...
      <div className="flex flex-col justify-center mt-16">
        ...
        >
          ...
          <div
            className="relative bg-no-repeat -top-24 flex justify-center rounded-full bg-cover shadow-[var(--shadow)] bg-center h-24 lg:h-44 w-24 lg:w-44 border-2 border-[#d3d3d3]"
            style={{
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between w-full">
              <div className="flex flex-col justify-center w-full lg:w-auto">
                ...
                >
                  ...
                  <option className="p-2 text-black" value="Thiruvananthapuram">
                    Thiruvananthapuram
                  </option>
