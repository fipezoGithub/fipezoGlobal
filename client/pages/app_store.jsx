      ...
      <div className={styles.body}>
        ...
        <h1 className={styles.heading}>
          ...
          >
            ...
            {clicked && (
              <p className="text-xs flex items-center sm:text-lg p-2 sm:p-3">
                <BsCheckCircleFill className="text-green-500" /> &nbsp; We will
                notify you when we launch our app
              </p>
            )}
          </form>
        </h1>
