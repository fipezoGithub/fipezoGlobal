...
const ShippingAndDelivery = (props) => {
  return (
    <>
      ...
      <div className="flex flex-col gap-4 mx-6 mb-4">
        <div className="flex gap-2 flex-col">
          <h2 className="font-bold text-lg">1. Service Delivery Process</h2>
          <p className="text-lg">
            At Fipezo, our focus is on connecting freelance artists with clients
            seamlessly. Here&apos;s an overview of our service delivery process:
          </p>

          <p className="text-lg">
            <span className="font-bold">Project Initiation:</span> Once
            you&apos;ve selected a freelance artist and initiated a project, the
            collaboration begins.
          </p>

          <p className="text-lg">
            <span className="font-bold">Project Timeline:</span> The timeline
            for project completion varies depending on the scope and complexity
            of the services required. Freelancers and clients work together to
        ...
        <div className="flex gap-2 flex-col">
          <h2 className="font-bold text-lg">3. International Collaboration</h2>
          <p className="text-lg">
          ...
          <p className="text-lg">
            <span className="font-bold">Digital Delivery:</span> The delivery of
            freelance services is facilitated digitally, eliminating the need
        ...
        <div className="flex gap-2 flex-col">
          ...
          <p className="text-lg">
            ...
            regarding project requirements and timelines. Any changes to project
            details or timelines should be discussed and agreed upon between the
